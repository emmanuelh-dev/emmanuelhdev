...
- To specify the name of the new file, append ?filename=<your_file_name> to the URL.
- Optionally, you can also add content to the new file by including &value=<your_content> in the URL.
